...
\
--item \
item-name='bootstrap_mud' \
item-path="${ia_share}"/pkgs/'bootstrap_mud.pkg' \
item-stage='setupassistant' \
item-type='package' \
item-url="${baseurl}"/pkgs/'bootstrap_mud.pkg' \
script-do-not-wait=false \
\
--item \
...
item-path="${ia_share}"/scripts/"${bootstrap_name}"/'munki_bootstrap_mud.py' \
item-stage='setupassistant' \
item-type='rootscript' \
item-url="${baseurl}"/scripts/"${bootstrap_name}"/'munki_bootstrap_mud.py' \
script-do-not-wait=false \
\
--item \
...
item-path="${ia_share}"/scripts/"${bootstrap_name}"/'finish_registration_mud.sh' \
item-stage='setupassistant' \
item-type='rootscript' \
item-url="${baseurl}"/scripts/"${bootstrap_name}"/'finish_registration_mud.sh' \
script-do-not-wait=false \
\
--item \
item-name='Finish DEPNotify' \
item-path="${ia_share}"/scripts/"${bootstrap_name}"/'finish_depnotify_mud.sh' \
item-stage='setupassistant' \
item-type='rootscript' \
item-url="${baseurl}"/scripts/"${bootstrap_name}"/'finish_depnotify_mud.sh' \
script-do-not-wait=false \
\
\
\
